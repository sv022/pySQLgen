...
russian_words : list = list(response.content.decode('cp1251').split())
...
data = {
    ...
    "name": ["Александр", "Владистас", "Андрей", "Игорь", "Олег", "Макс", "Сергей", "Никита", "Антон", "Леха", "Алексей",
             "Дмитрий", "Стас", "Богдан"],
    "lastname": ["Александров", "Владистасов", "Андреевич", "Игоревич", "Олегович", "Максов", "Алексеевич", "Владиморович", "Богданович"],
    ...
    "edu_programs": {
       ...
       # books
       "genres": ["Роман", "Комедия", "Драма", "Повесть", "Рассказ", "Триллер", "Фэнтези"]  
}
